    ...
    () => {
            ...
            <R as frame_system::Config>::RuntimeEvent: From<pallet_balances::Event<R, ArgonToken>>,
        {
            fn on_nonzero_unbalanced(
                imbalance: fungible::Credit<R::AccountId, pallet_balances::Pallet<R, ArgonToken>>,
            ) {
        ...
        impl<T> TransactionExtension<T::RuntimeCall> for ProxyFeeRefund<T>
        where
            T: frame_system::Config<AccountId = AccountId, RuntimeCall = RuntimeCall> + Send + Sync,
            T::RuntimeCall: Dispatchable<Info = DispatchInfo, PostInfo = PostDispatchInfo>,
        {
            ...
            fn post_dispatch_details(
                ...
                // TODO: we need to wrap the transaction payment extension to get to the tip
                let tip = Zero::zero();
                ...
                if let Err(err) = <Balances as fungible::Mutate<AccountId>>::transfer(
                    &real,
                    &proxy,
                    actual_fee,
