		...
		>(|_id, vec| {
			...
			let new = vec
				...
				.map(|v| VaultFrameRevenue {
					...
					bitcoin_lock_fee_coupon_value_used: v.bitcoin_lock_fee_revenue,
					bitcoin_locks_created: v.bitcoin_locks_created,
					bitcoin_locks_new_liquidity_promised: v.bitcoin_locks_new_liquidity_promised,
					bitcoin_locks_released_liquidity: v.bitcoin_locks_released_liquidity,
					bitcoin_locks_added_satoshis: v.bitcoin_locks_added_satoshis,
					bitcoin_locks_released_satoshis: v.bitcoin_locks_released_satoshis,
					securitization_relockable: v.securitization_relockable,
		...
		new_test_ext().execute_with(|| {
			old_storage::RevenuePerFrameByVault::<Test>::try_mutate(1u32, |v| {
				v.try_push(old_storage::VaultFrameRevenue {
					...
					bitcoin_locks_added_satoshis: 500u32.into(),
					bitcoin_locks_new_liquidity_promised: 10_000,
					bitcoin_locks_released_liquidity: 1_000,
					bitcoin_locks_released_satoshis: 0u32.into(),
					securitization_relockable: 0u32.into(),
			...
			old_storage::RevenuePerFrameByVault::<Test>::try_mutate(2u32, |v| {
				v.try_push(old_storage::VaultFrameRevenue {
					...
					bitcoin_locks_added_satoshis: 600u32.into(),
					bitcoin_locks_new_liquidity_promised: 20_000,
					bitcoin_locks_released_satoshis: 2_000,
					bitcoin_locks_released_liquidity: 1_000,
					securitization_relockable: 0u32.into(),
			...
			assert_eq!(rev_1.bitcoin_lock_fee_coupon_value_used, 100u32.into());
			...
			assert_eq!(rev_2.bitcoin_lock_fee_coupon_value_used, 200u32.into());
		});
	}
}
