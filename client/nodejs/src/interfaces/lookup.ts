...
export default {
  ...
  /**
   * Lookup136: pallet_restricted_account::pallet::Event<T>
   **/
  ...
  /**
   * Lookup317: pallet_restricted_account::pallet::Call<T>
   **/
  ...
  /**
   * Lookup343: argon_primitives::block_seal::MiningBidStats
   **/
  ...
  /**
   * Lookup349: pallet_mining_slot::pallet::Error<T>
   **/
  ...
  /**
   * Lookup350: argon_primitives::bitcoin::UtxoValue
   **/
  ...
  /**
   * Lookup351: argon_primitives::bitcoin::BitcoinCosignScriptPubkey
   **/
  ...
  /**
   * Lookup356: argon_primitives::bitcoin::BitcoinNetwork
   **/
  ...
  /**
   * Lookup364: argon_primitives::bitcoin::BitcoinXPub
   **/
  ...
  /**
   * Lookup366: argon_primitives::bitcoin::NetworkKind
   **/
  ...
  /**
   * Lookup373: pallet_vaults::pallet::VaultFrameFeeRevenue<T>
   **/
  ...
  /**
   * Lookup375: pallet_vaults::pallet::Error<T>
   **/
  PalletVaultsError: {
    _enum: [
      'ObligationNotFound',
  ...
  /**
   * Lookup376: pallet_bitcoin_locks::pallet::LockedBitcoin<T>
   **/
  ...
  /**
   * Lookup380: pallet_bitcoin_locks::pallet::LockReleaseRequest<Balance>
   **/
  ...
  /**
   * Lookup384: pallet_bitcoin_locks::pallet::Error<T>
   **/
  ...
  /**
   * Lookup385: argon_primitives::vault::ObligationError
   **/
  ...
  /**
   * Lookup397: pallet_notaries::pallet::Error<T>
   **/
  PalletNotariesError: {
    _enum: [
      'ProposalNotFound',
  ...
  /**
   * Lookup401: argon_primitives::notary::NotaryNotebookKeyDetails
   **/
  ...
  /**
   * Lookup404: pallet_notebook::pallet::Error<T>
   **/
  PalletNotebookError: {
    _enum: [
  ...
  /**
   * Lookup405: pallet_chain_transfer::QueuedTransferOut<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup412: pallet_chain_transfer::pallet::Error<T>
   **/
  ...
  /**
   * Lookup417: argon_primitives::notary::NotaryNotebookVoteDigestDetails
   **/
  ...
  /**
   * Lookup422: pallet_block_seal_spec::pallet::Error<T>
   **/
  PalletBlockSealSpecError: {
    _enum: ['MaxNotebooksAtTickExceeded'],
  },
  /**
   * Lookup424: pallet_domains::pallet::Error<T>
   **/
  PalletDomainsError: {
    _enum: [
      'DomainNotRegistered',
  ...
  /**
   * Lookup425: pallet_price_index::pallet::Error<T>
   **/
  ...
  /**
   * Lookup430: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: [
      'PauseFailed',
  ...
  /**
   * Lookup431: argon_primitives::providers::BlockSealerInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup435: pallet_block_seal::pallet::Error<T>
   **/
  ...
  /**
   * Lookup441: pallet_block_rewards::pallet::Error<T>
   **/
  PalletBlockRewardsError: 'Null',
  /**
   * Lookup448: pallet_mint::pallet::MintAction<Balance>
   **/
  ...
  /**
   * Lookup449: pallet_mint::pallet::Error<T>
   **/
  PalletMintError: {
  ...
  /**
   * Lookup458: frame_support::traits::tokens::misc::IdAmount<argon_runtime::RuntimeHoldReason, Balance>
   **/
  ...
  /**
   * Lookup459: argon_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup460: pallet_mining_slot::pallet::HoldReason
   **/
  PalletMiningSlotHoldReason: {
    _enum: ['RegisterAsMiner'],
  },
  /**
   * Lookup461: pallet_vaults::pallet::HoldReason
   **/
  PalletVaultsHoldReason: {
    _enum: ['EnterVault', 'ObligationFee'],
  },
  /**
   * Lookup462: pallet_bitcoin_locks::pallet::HoldReason
   **/
  PalletBitcoinLocksHoldReason: {
    _enum: ['ReleaseBitcoinLock'],
  },
  /**
   * Lookup463: pallet_block_rewards::pallet::HoldReason
   **/
  PalletBlockRewardsHoldReason: {
    _enum: ['MaturationPeriod'],
  },
  /**
   * Lookup464: pallet_liquidity_pools::pallet::HoldReason
   **/
  PalletLiquidityPoolsHoldReason: {
    _enum: ['ContributedToLiquidityPool'],
  },
  /**
   * Lookup467: frame_support::traits::tokens::misc::IdAmount<argon_runtime::RuntimeFreezeReason, Balance>
   **/
  ...
  /**
   * Lookup468: argon_runtime::RuntimeFreezeReason
   **/
  ...
  /**
   * Lookup469: pallet_block_rewards::pallet::FreezeReason
   **/
  PalletBlockRewardsFreezeReason: {
    _enum: ['MaturationPeriod'],
  },
  /**
   * Lookup471: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
    _enum: [
      'VestingBalance',
  ...
  /**
   * Lookup473: pallet_tx_pause::pallet::Error<T>
   **/
  PalletTxPauseError: {
    _enum: ['IsPaused', 'IsUnpaused', 'Unpausable', 'NotFound'],
  },
  /**
   * Lookup474: pallet_transaction_payment::Releases
   **/
  PalletTransactionPaymentReleases: {
    _enum: ['V1Ancient', 'V2'],
  },
  /**
   * Lookup475: pallet_utility::pallet::Error<T>
   **/
  PalletUtilityError: {
    _enum: ['TooManyCalls'],
  },
  /**
   * Lookup476: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo'],
  },
  /**
   * Lookup477: pallet_ismp::pallet::Error<T>
   **/
  PalletIsmpError: {
    _enum: [
      'InvalidMessage',
  ...
  /**
   * Lookup478: pallet_hyperbridge::pallet::Error<T>
   **/
  PalletHyperbridgeError: 'Null',
  /**
   * Lookup480: pallet_token_gateway::pallet::Error<T>
   **/
  ...
  /**
   * Lookup482: pallet_liquidity_pools::pallet::LiquidityPool<T>
   **/
  ...
  /**
   * Lookup491: pallet_liquidity_pools::pallet::LiquidityPoolCapital<T>
   **/
  ...
  /**
   * Lookup493: pallet_liquidity_pools::pallet::Error<T>
   **/
  ...
  /**
   * Lookup494: pallet_restricted_account::pallet::Error<T>
   **/
  ...
  /**
   * Lookup505: pallet_restricted_account::CheckRestrictedAccess<T>
   **/
  ...
  /**
   * Lookup510: argon_runtime::Runtime
   **/
