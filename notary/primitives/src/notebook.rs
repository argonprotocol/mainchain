...
use crate::{block_vote::BlockVote, AccountOrigin, AccountType, BalanceChange, BestBlockNonce};
...
pub struct NotebookHeader {
	...
	/// A block number that this notebook can be applied to
	#[codec(compact)]
	...
	#[codec(compact)]
	pub tax: u128,
	/// Utc millis in notary server time when this notebook began
	pub start_time: u64,
	/// Utc millis in notary server time when this notebook ended
	pub end_time: u64,
	#[codec(compact)]
	...
	/// The top block nonces bound to the grandparent notebook votes
	pub best_block_nonces: BoundedVec<(H256, BestBlockNonce), ConstU32<500>>,
}
