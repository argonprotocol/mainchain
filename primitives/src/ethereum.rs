...
/// Receipt trie proofs are expected to stay short; cap node count to bound decode/proof work.
pub const MAX_ETHEREUM_RECEIPT_PROOF_NODES: u32 = 16;
...
pub type EthereumReceiptProofNodes =
	BoundedVec<EthereumReceiptProofNode, ConstU32<MAX_ETHEREUM_RECEIPT_PROOF_NODES>>;
...
pub struct EthereumReceiptProof {
	...
	pub nodes: EthereumReceiptProofNodes,
}
