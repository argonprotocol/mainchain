...
export default {
  ...
  /**
   * Lookup330: argon_primitives::block_seal::MiningSlotConfig
   **/
  ...
  /**
   * Lookup343: argon_primitives::vault::Vault<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup344: argon_primitives::vault::VaultArgons<Balance>
   **/
  ...
  /**
   * Lookup356: argon_primitives::vault::Obligation<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup360: pallet_vaults::pallet::BidPoolEntrant<T>
   **/
  ...
  /**
   * Lookup364: pallet_vaults::pallet::Error<T>
   **/
  PalletVaultsError: {
    _enum: [
      'ObligationNotFound',
  ...
  /**
   * Lookup365: pallet_bitcoin_locks::pallet::LockedBitcoin<T>
   **/
  ...
  /**
   * Lookup369: pallet_bitcoin_locks::pallet::LockReleaseRequest<Balance>
   **/
  ...
  /**
   * Lookup373: pallet_bitcoin_locks::pallet::Error<T>
   **/
  ...
  /**
   * Lookup374: argon_primitives::vault::ObligationError
   **/
  ...
  /**
   * Lookup386: pallet_notaries::pallet::Error<T>
   **/
  PalletNotariesError: {
    _enum: [
      'ProposalNotFound',
  ...
  /**
   * Lookup390: argon_primitives::notary::NotaryNotebookKeyDetails
   **/
  ...
  /**
   * Lookup393: pallet_notebook::pallet::Error<T>
   **/
  PalletNotebookError: {
    _enum: [
  ...
  /**
   * Lookup394: pallet_chain_transfer::QueuedTransferOut<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup400: pallet_chain_transfer::pallet::Error<T>
   **/
  ...
  /**
   * Lookup405: argon_primitives::notary::NotaryNotebookVoteDigestDetails
   **/
  ...
  /**
   * Lookup410: pallet_block_seal_spec::pallet::Error<T>
   **/
  PalletBlockSealSpecError: {
    _enum: ['MaxNotebooksAtTickExceeded'],
  },
  /**
   * Lookup412: pallet_domains::pallet::Error<T>
   **/
  PalletDomainsError: {
    _enum: [
      'DomainNotRegistered',
  ...
  /**
   * Lookup413: pallet_price_index::pallet::Error<T>
   **/
  ...
  /**
   * Lookup414: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup415: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup419: argon_primitives::providers::BlockSealerInfo<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup423: pallet_block_seal::pallet::Error<T>
   **/
  ...
  /**
   * Lookup430: pallet_block_rewards::pallet::Error<T>
   **/
  PalletBlockRewardsError: 'Null',
  /**
   * Lookup435: pallet_mint::MintAction<Balance>
   **/
  ...
  /**
   * Lookup436: pallet_mint::pallet::Error<T>
   **/
  PalletMintError: {
    _enum: ['TooManyPendingMints'],
  },
  /**
   * Lookup438: pallet_balances::types::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup439: pallet_balances::types::Reasons
   **/
  PalletBalancesReasons: {
    _enum: ['Fee', 'Misc', 'All'],
  },
  /**
   * Lookup442: pallet_balances::types::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup445: frame_support::traits::tokens::misc::IdAmount<argon_runtime::RuntimeHoldReason, Balance>
   **/
  ...
  /**
   * Lookup446: argon_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup447: pallet_mining_slot::pallet::HoldReason
   **/
  PalletMiningSlotHoldReason: {
    _enum: ['RegisterAsMiner'],
  },
  /**
   * Lookup448: pallet_vaults::pallet::HoldReason
   **/
  PalletVaultsHoldReason: {
    _enum: ['EnterVault', 'ObligationFee'],
  },
  /**
   * Lookup449: pallet_bitcoin_locks::pallet::HoldReason
   **/
  PalletBitcoinLocksHoldReason: {
    _enum: ['ReleaseBitcoinLock'],
  },
  /**
   * Lookup450: pallet_block_rewards::pallet::HoldReason
   **/
  PalletBlockRewardsHoldReason: {
    _enum: ['MaturationPeriod'],
  },
  /**
   * Lookup453: frame_support::traits::tokens::misc::IdAmount<argon_runtime::RuntimeFreezeReason, Balance>
   **/
  ...
  /**
   * Lookup454: argon_runtime::RuntimeFreezeReason
   **/
  ...
  /**
   * Lookup455: pallet_block_rewards::pallet::FreezeReason
   **/
  PalletBlockRewardsFreezeReason: {
    _enum: ['MaturationPeriod'],
  },
  /**
   * Lookup457: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
    _enum: [
      'VestingBalance',
  ...
  /**
   * Lookup459: pallet_tx_pause::pallet::Error<T>
   **/
  PalletTxPauseError: {
    _enum: ['IsPaused', 'IsUnpaused', 'Unpausable', 'NotFound'],
  },
  /**
   * Lookup460: pallet_transaction_payment::Releases
   **/
  ...
  /**
   * Lookup462: pallet_sudo::pallet::Error<T>
   **/
  PalletSudoError: {
    _enum: ['RequireSudo'],
  },
  /**
   * Lookup463: pallet_ismp::pallet::Error<T>
   **/
  PalletIsmpError: {
    _enum: [
      'InvalidMessage',
  ...
  /**
   * Lookup464: pallet_hyperbridge::pallet::Error<T>
   **/
  PalletHyperbridgeError: 'Null',
  /**
   * Lookup466: pallet_token_gateway::pallet::Error<T>
   **/
  ...
  /**
   * Lookup478: frame_metadata_hash_extension::CheckMetadataHash<T>
   **/
  FrameMetadataHashExtensionCheckMetadataHash: {
    mode: 'FrameMetadataHashExtensionMode',
  },
  /**
   * Lookup479: frame_metadata_hash_extension::Mode
   **/
  FrameMetadataHashExtensionMode: {
    _enum: ['Disabled', 'Enabled'],
  },
  /**
   * Lookup481: argon_runtime::Runtime
   **/
