...
impl<T: frame_system::Config> ismp_grandpa::WeightInfo for WeightInfo<T> {
	...
	fn add_state_machines(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_091_387, 0)
			// Standard Error: 3_511
			.saturating_add(Weight::from_parts(1_388_456, 0).saturating_mul(n.into()))
	...
	fn remove_state_machines(n: u32, ) -> Weight {
		...
		Weight::from_parts(5_007_510, 0)
			// Standard Error: 2_283
			.saturating_add(Weight::from_parts(1_321_481, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(n.into())))
		}
	}
