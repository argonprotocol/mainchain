...
//! Verification wrapper types imported from Snowbridge verification primitives.
//!
//! Upstream source:
//! - crate: `snowbridge-verification-primitives`
//! - version: `0.8.1`
//! - repository: `https://github.com/paritytech/polkadot-sdk`
//! - path: `bridges/snowbridge/primitives/verification/src/lib.rs`
//!
//! This module is kept local so the verifier pallet does not depend on the full upstream
//! verification-primitives crate while Argon owns its runtime-facing verifier boundary.
#![allow(dead_code)]
