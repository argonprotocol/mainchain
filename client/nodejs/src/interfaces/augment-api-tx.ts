...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    bitcoinLocks: {
      ...
      registerFeeCoupon: AugmentedSubmittable<(public: U8aFixed | string | Uint8Array, maxSatoshis: Compact<u64> | AnyNumber | Uint8Array, maxFeePlusTip: Option<u128> | null | Uint8Array | u128 | AnyNumber) => SubmittableExtrinsic<ApiType>, [U8aFixed, Compact<u64>, Option<u128>]>;
    ...
    treasury: {
       ...
       **/
      setAllocation: AugmentedSubmittable<(vaultId: u32 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32, u128]>;
    };
    txPause: {
      /**
       * Pause a call.
