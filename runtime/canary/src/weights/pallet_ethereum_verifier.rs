...
impl<T: frame_system::Config> pallet_ethereum_verifier::WeightInfo for WeightInfo<T> {
	...
	/// Proof: `EthereumVerifier::ExecutionHeaderAnchorsByBlockNumber` (`max_values`: None, `max_size`: Some(120), added: 2595, mode: `MaxEncodedLen`)
	...
	fn force_checkpoint() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `3501`
		// Minimum execution time: 68_375_000_000 picoseconds.
		Weight::from_parts(71_125_000_000, 3501)
	...
	fn submit() -> Weight {
		...
		//  Measured:  `92504`
		//  Estimated: `93859`
		// Minimum execution time: 16_928_000_000 picoseconds.
		Weight::from_parts(17_563_000_000, 93859)
	...
	fn submit_with_sync_committee() -> Weight {
		...
		//  Measured:  `92504`
		//  Estimated: `93859`
		// Minimum execution time: 85_498_000_000 picoseconds.
		Weight::from_parts(87_031_000_000, 93859)
	...
	fn provider_verify_receipt_logs(b: u32, e: u32, ) -> Weight {
		...
		Weight::from_parts(64_000_000, 3609)
			// Standard Error: 74_744
			.saturating_add(Weight::from_parts(1_861_985, 0).saturating_mul(b.into()))
			// Standard Error: 50_118
			.saturating_add(Weight::from_parts(4_808_596, 0).saturating_mul(e.into()))
	...
	fn provider_latest_execution_block_number() -> Weight {
		...
		Weight::from_parts(5_000_000, 3609)
			.saturating_add(T::DbWeight::get().reads(2))
		}
	/// Storage: `EthereumVerifier::LatestExecutionHeaderAnchorBlockHash` (r:1 w:0)
	/// Proof: `EthereumVerifier::LatestExecutionHeaderAnchorBlockHash` (`max_values`: Some(1), `max_size`: Some(32), added: 527, mode: `MaxEncodedLen`)
