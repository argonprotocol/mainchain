...
impl<T: frame_system::Config> pallet_operational_accounts::WeightInfo for WeightInfo<T> {
	...
	fn register() -> Weight {
		...
		Weight::from_parts(217_000_000, 35483)
	...
	fn on_treasury_pool_participated() -> Weight {
		...
		Weight::from_parts(14_000_000, 3767)
			.saturating_add(T::DbWeight::get().reads(3))
			.saturating_add(T::DbWeight::get().writes(1))
		}
	/// Storage: `OperationalAccounts::OperationalAccountBySubAccount` (r:1 w:0)
	...
	fn provider_pending_rewards() -> Weight {
		...
		Weight::from_parts(40_000_000, 82487)
	...
	fn provider_mark_reward_paid() -> Weight {
		...
		Weight::from_parts(55_000_000, 82487)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn force_set_progress() -> Weight {
		...
		//  Estimated: `3767`
		// Minimum execution time: 12_000_000 picoseconds.
		Weight::from_parts(13_000_000, 3767)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
		}
