...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    miningSlot: {
       ...
       **/
      nextCohortFrameId: AugmentedQuery<ApiType, () => Observable<u64>, []>;
      /**
    ...
    vaults: {
       ...
       **/
      perFrameFeeRevenueByVault: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<PalletVaultsVaultFrameFeeRevenue>>, [u32]>;
      /**
       * Vaults by id
       **/
