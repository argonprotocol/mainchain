...
pub mod weights;
const LOG_TARGET: &str = "runtime::bonds";

/// The bonds pallet allows users to lock funds for a period of time, and optionally lease them out
...
/// accept new bonds, and will return any expired bonds to the bond fund provider once they are
/// completed.
///
...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		/// Stop offering this fund for new bonds. Will not affect existing bonds. Unreserved funds
