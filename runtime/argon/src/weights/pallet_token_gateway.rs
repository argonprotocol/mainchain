...
impl<T: frame_system::Config> pallet_token_gateway::WeightInfo for WeightInfo<T> {
	...
	fn create_erc6160_asset(x: u32, ) -> Weight {
		...
		Weight::from_parts(11_256_145, 0)
			// Standard Error: 3_343
			.saturating_add(Weight::from_parts(1_826_786, 0).saturating_mul(x.into()))
	...
	fn set_token_gateway_addresses(x: u32, ) -> Weight {
		...
		Weight::from_parts(4_171_380, 0)
			// Standard Error: 640
			.saturating_add(Weight::from_parts(971, 0).saturating_mul(x.into()))
	...
	fn update_asset_precision(x: u32, ) -> Weight {
		...
		Weight::from_parts(3_227_722, 0)
			// Standard Error: 3_834
			.saturating_add(Weight::from_parts(1_817_358, 0).saturating_mul(x.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(x.into())))
		}
