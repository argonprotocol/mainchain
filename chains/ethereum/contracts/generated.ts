...
export const mintingGatewayAbi = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'from', internalType: 'address', type: 'address', indexed: true },
      { name: 'token', internalType: 'address', type: 'address', indexed: true },
      { name: 'amount', internalType: 'uint64', type: 'uint64', indexed: false },
...
export const mintingGatewayV2Abi = [
    ...
    inputs: [
      ...
      { name: 'relayerArgonAccountId', internalType: 'bytes32', type: 'bytes32', indexed: false },
      {
        ...
        components: [
          ...
          { name: 'argonCirculation', internalType: 'uint64', type: 'uint64' },
          { name: 'argonotCirculation', internalType: 'uint64', type: 'uint64' },
        ],
        indexed: false,
      },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'microgonCollateral', internalType: 'uint64', type: 'uint64', indexed: false },
      { name: 'micronotCollateral', internalType: 'uint64', type: 'uint64', indexed: false },
    ...
    inputs: [
      { name: 'transferId', internalType: 'bytes32', type: 'bytes32', indexed: false },
      {
        ...
        components: [
          ...
          { name: 'microgonCollateral', internalType: 'uint64', type: 'uint64' },
          { name: 'micronotCollateral', internalType: 'uint64', type: 'uint64' },
        ],
        indexed: false,
      },
      {
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: 'token', internalType: 'address', type: 'address' },
          { name: 'amount', internalType: 'uint64', type: 'uint64' },
          { name: 'microgonsPerArgonot', internalType: 'uint256', type: 'uint256' },
          { name: 'requiredCollateralMicrogons', internalType: 'uint64', type: 'uint64' },
          { name: 'finalizationTip', internalType: 'uint64', type: 'uint64' },
        ],
      },
    ],
