...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    liquidityPools: {
       ...
       **/
      ErrorRefundingLiquidityPoolCapital: AugmentedEvent<ApiType, [frameId: u64, vaultId: u32, amount: u128, accountId: AccountId32, dispatchError: SpRuntimeDispatchError], { frameId: u64, vaultId: u32, amount: u128, accountId: AccountId32, dispatchError: SpRuntimeDispatchError }>;
      /**
       ...
       * capital
       **/
      RefundedLiquidityPoolCapital: AugmentedEvent<ApiType, [frameId: u64, vaultId: u32, amount: u128, accountId: AccountId32], { frameId: u64, vaultId: u32, amount: u128, accountId: AccountId32 }>;
    };
    miningSlot: {
      /**
       * Bids are closed due to the VRF randomized function triggering
       **/
      MiningBidsClosed: AugmentedEvent<ApiType, [cohortFrameId: u64], { cohortFrameId: u64 }>;
      ...
      NewMiners: AugmentedEvent<ApiType, [startIndex: u32, newMiners: Vec<ArgonPrimitivesBlockSealMiningRegistration>, releasedMiners: u32, cohortFrameId: u64], { startIndex: u32, newMiners: Vec<ArgonPrimitivesBlockSealMiningRegistration>, releasedMiners: u32, cohortFrameId: u64 }>;
    ...
    mint: {
       ...
       * not be able to mint
       **/
      MiningMint: AugmentedEvent<ApiType, [amount: U256, perMiner: u128, argonCpi: i128, liquidity: u128], { amount: U256, perMiner: u128, argonCpi: i128, liquidity: u128 }>;
      /**
    ...
    vaults: {
      ObligationCompleted: AugmentedEvent<ApiType, [vaultId: u32, obligationId: u64, wasCanceled: bool], { vaultId: u32, obligationId: u64, wasCanceled: bool }>;
      /**
      ...
      VaultClosed: AugmentedEvent<ApiType, [vaultId: u32, remainingSecuritization: u128, released: u128], { vaultId: u32, remainingSecuritization: u128, released: u128 }>;
