...
impl<T: frame_system::Config> pallet_crosschain_transfer::WeightInfo for WeightInfo<T> {
	...
	fn force_set_global_issuance_council() -> Weight {
		...
		Weight::from_parts(90_000_000, 23704)
	...
	fn register_minting_authority() -> Weight {
		...
		Weight::from_parts(87_000_000, 12347)
			.saturating_add(T::DbWeight::get().reads(14))
	...
	fn approve_queue_entries(a: u32, ) -> Weight {
		...
		Weight::from_parts(7_830_642, 12347)
			// Standard Error: 47_802
			.saturating_add(Weight::from_parts(13_770_371, 0).saturating_mul(a.into()))
	...
	fn prove_gateway_activity(a: u32, ) -> Weight {
		...
		// Minimum execution time: 9_047_000_000 picoseconds.
		Weight::from_parts(9_136_158_272, 1612950)
			// Standard Error: 1_753_040
			.saturating_add(Weight::from_parts(196_677_236, 0).saturating_mul(a.into()))
	...
	fn on_initialize_cleanup(e: u32, ) -> Weight {
		...
		Weight::from_parts(11_000_000, 3593)
			...
			.saturating_add(Weight::from_parts(3_605_944, 0).saturating_mul(e.into()))
