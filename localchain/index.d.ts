...
export class BalanceChangeBuilder {
    ...
    createChannelHold(amount: bigint, paymentAddress: string, delegatedSignerAddress?: string | undefined | null): Promise<void>
...
export class BalanceSyncResult {
    ...
    get channel_holdNotarizations(): Array<NotarizationBuilder>
...
export class NotarizationBuilder {
    ...
    get channel_holds(): Promise<Array<ChannelHold>>
...
export class OpenChannelHold {
    get channel_hold(): Promise<ChannelHold>
...
export class TickerRef {
    ...
    get channel_holdExpirationTicks(): Tick
}
...
export class Transactions {
    ...
    createChannelHold(channelHoldMilligons: bigint, recipientAddress: string, notaryId?: number | undefined | null, delegatedSignerAddress?: string | undefined | null): Promise<OpenChannelHold>
